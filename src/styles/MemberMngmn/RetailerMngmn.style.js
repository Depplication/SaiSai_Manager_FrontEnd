...
export const RetailerMngmnLayout = styled.div`
  display: flex;
  ...
  margin-top: 4rem;
`;
export const RetailerMngmnContainer = styled.div``;
...
export const RetailerMemberTable = styled.table`
  width: 100%;
...
export const HeaderAccountNumber = styled.td`
  width: 12.188rem;
...
export const HeaderBank = styled.td`
  width: 7rem;
...
export const BodyAccountNumber = styled.td`
  padding-left: 0.5rem;
`;
...
export const BodyBank = styled.td`
  padding-left: 0.5rem;
`;
